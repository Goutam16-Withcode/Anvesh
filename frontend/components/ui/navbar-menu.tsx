...
export const Menu = ({
  ...
  return (
    <nav
      ...
      className="relative rounded-full border border-slate-200/60 bg-slate-100/70 dark:bg-slate-800/70 backdrop-blur-md flex items-center justify-center space-x-1 px-3 py-1 shadow-sm"
    >
      {children}
    </nav>
  );
